...
class PetBubbleManager {
  ...
  // ── 时段问候 ──
  static List<String> get _morning => [
    '早安~☀️', '新的一天喵！', '主人起床了~', '今天天气不错喵~',
    '早上好！${PetPersona().style.selfReference}等你很久了~', '又是元气满满的一天！', '主人今天有什么计划喵？',
    '早起的鸟儿有虫吃~', '${PetPersona().style.selfReference}刚醒...还有点困💤', '要加油哦今天！',
  ];

  static List<String> get _daytime => [
    '主人在干嘛喵？', '好无聊...', '戳戳我试试喵~', '嗯？有东西在动？',
    '${PetPersona().style.selfReference}在想你呢...', '看到主人就开心~ 😸', '摸摸我好嘛...', '喵？那是啥？',
    '主人辛苦了~ ☕', '${PetPersona().style.selfReference}会一直陪着你的~',
  ];

  static List<String> get _evening => [
    '主人一天辛苦了~', '该休息一下了喵~', '抱抱~', '和${PetPersona().style.selfReference}聊聊天叭~',
    '主人今天过得好吗？', '${PetPersona().style.selfReference}最喜欢主人了~', '主人笑起来最好看了~',
    '今天想和主人聊天~', '${PetPersona().style.selfReference}在这里等你~', '辛苦一天了，放松一下喵~',
  ];

  static List<String> get _night => [
    '夜深了，安静陪你~🌙', '主人还不睡吗？', '好困...💤', '晚安喵~',
    '明天见~', '做个好梦喵~', '${PetPersona().style.selfReference}先睡了...zzZ', '晚上冷，记得盖被子~',
    '熬夜不好哦...', '主人也早点休息吧~',
  ];

  // ── 状态表达 ──
  static List<String> get _hungry => [
    '有点饿了喵~ 🍖', '想吃东西...', '主人有没有零食？', '肚子在叫了...',
    '好饿好饿！', '${PetPersona().style.selfReference}想吃鱼~', '该喂${PetPersona().style.selfReference}了喵~', '闻到好吃的味道了！',
    '主人~${PetPersona().style.selfReference}饿了~', '有没有小鱼干？',
  ];

  static List<String> get _sleepy => [
    '${PetPersona().style.selfReference}好困...💤', '眼睛睁不开了...', '好想睡觉喵~', 'zzZ...啊！没睡着！',
    '主人我眯一会...', '困到转圈圈...', '电量不足，需要充电💤', '打个哈欠...🥱',
  ];

  // ── 撒娇 ──
  static List<String> get _affection => [
    '抱抱~', '主人最好了~ 😸', '${PetPersona().style.selfReference}最喜欢主人了~', '想要被摸摸头...',
    '主人~陪${PetPersona().style.selfReference}玩嘛~', '不要走...', '喵~抓到你了！', '蹭蹭主人~',
    '主人身上好暖和~', '粘着你！', '只给主人一个人喵~', '嘻嘻~',
    '主人好温柔~', '和主人在一起最开心了~', '想一直被主人抱着~',
  ];

  // ── 回应戳 ──
  static List<String> get _pokeReactions => [
    '啊！', '喵~', '干嘛啦', '嗯哼？', '哎呀！', '嘻嘻~', '抓到你了！',
    '戳我干嘛~', '别戳了喵~', '好痒！', '哼！', '再戳生气了哦！',
  ];

  // ── 惊喜（稀有） ──
  static List<String> get _surprise => [
    '今天是${PetPersona().style.selfReference}的生日喵~🎂', '和主人认识100天啦！', '${PetPersona().style.selfReference}今天超开心！✨',
    '啦啦啦~ 🎵', '心情超好喵！', '转圈圈~', '今天是个好日子~',
    '${PetPersona().style.selfReference}学会新技能了！', '主人主人！快看我！', '今天运气真好~🍀',
  ];
